    ...
    private:
        ...
        void mpu_setup() {
            // join I2C bus (I2Cdev library doesn't do this automatically)
                ...
                Wire.begin();
                Wire.setTimeout(3);
                Wire.setClock(300000); // 300kHz I2C clock. Comment this line if having compilation difficulties
            ...
            // Your offsets:   -2281   2150    1318    -68     -77     31
            // supply your own gyro offsets here, scaled for min sensitivity
            // mpu.setXAccelOffset(-2281);
            // mpu.setYAccelOffset(2150);
            // mpu.setZAccelOffset(1318);
            // mpu.setXGyroOffset(-68);
            // mpu.setYGyroOffset(-77);
            // mpu.setZGyroOffset(31);

            mpu.setXAccelOffset(-4882);
        ...
        void mpu_loop() {
            ...
            // check for overflow (this should never happen unless our code is too inefficient <100Hz) 
